...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Jun 2021 pada 02.03
...
--
-- Struktur dari tabel `history_order`
--
...
--
-- Dumping data untuk tabel `history_order`
--

INSERT INTO `history_order` (`order_id`, `nama`, `email`, `no`, `alamat`, `gross_amount`, `payment_type`, `transaction_time`, `bank`, `va_number`, `status_code`) VALUES
('1152173382', 'test', 'test@gmail.com', '1241242354325', 'jl. jeruk no 21', 355000, 'bank_transfer', '2021-06-23 02:35:20', 'bca', '19365154783', '200'),
('1622716183', 'admin', 'admin@gmail.com', '5435436363', 'jl. sirsak no 1', 210000, 'bank_transfer', '2021-06-23 02:40:01', 'bca', '19365736491', '202');
...
INSERT INTO `produk` (`id`, `nama`, `slug`, `category`, `subcategory`, `deskripsi`, `warna`, `merk`, `stok`, `harga`, `list_popular`, `diskon`, `harga_diskon`, `gambar`, `berat`) VALUES
(17, 'Baby walker 136L', 'Baby-walker-136L', 'Balita', '', '', 'Pink', 'Family', 5, 500000, 1, 1, 250000, '136L.png', 5000),
(18, 'Baby walker 1817', 'Baby-walker-1817', 'Balita', '', '', 'Biru', 'Family', 5, 50000, NULL, NULL, 0, '1817.png', 5000),
(19, 'Baby walker 2115', 'Baby-walker-2115', 'Balita', '', '', 'Blue', 'Family', 5, 50000, NULL, NULL, 0, '2115.png', 5000),
(20, 'Stroller 5012', 'Stroller-5012', 'Balita', '', '', 'Abu', 'Space Baby', 5, 300000, 1, NULL, 0, 'sb5012.png', 5000),
(21, 'Batman Size 12', 'Batman-Size-12', 'Anak', '', '', 'Abu Yellow', 'Pasific', 5, 300000, NULL, NULL, 0, 'batman12.png', 5000),
(22, 'Batman Size 16', 'Batman-Size-16', 'Anak', '', '', 'Abu Yellow', 'Pasific', 1, 500000, 1, NULL, 0, 'batman16.png', 5000),
(23, 'Batman Size 18', 'Batman-Size-18', 'Anak', '', '', 'Abu Yellow', 'Pasific', 5, 500000, NULL, NULL, 0, 'batman18.png', 5000),
(24, 'Transformer Size 12', 'Transformer-Size-12', 'Anak', '', '', 'Kuning', 'Pasific', 1, 500000, 1, NULL, 0, 'bumblebee12.png', 5000),
(25, 'Transformer Size 16', 'Transformer-Size-16', 'Anak', '', '', 'Kuning', 'Pasific', 3, 600000, NULL, NULL, 0, 'bumblebee16.png', 5000),
(26, 'Transformer Size 18', 'Transformer-Size-18', 'Anak', '', '', 'Kuning', 'Pasific', 3, 700000, NULL, NULL, 0, 'bumblebee18.png', 5000),
(27, 'Flux 70 Sepeda Lipat', 'Flux-70-Sepeda-Lipat', 'Dewasa', 'City Bike', '', 'Hitam', 'Pasific', 5, 1000000, 1, NULL, 0, 'flux70.png', 5000),
(28, 'Splendid 300 sepeda lipat', 'Splendid-300-sepeda-lipat', 'Dewasa', 'City Bike', '', 'Hitam', 'Pasific', 3, 3000000, 1, NULL, 0, 'splendid300.png', 5000),
(29, 'Nigma Sepeda lipat', 'Nigma-Sepeda-lipat', 'Dewasa', 'City Bike', '', '', 'United', 2, 5000000, NULL, NULL, 0, 'nigma.png', 5000),
(30, 'Detroit 1.0', 'Detroit-10', 'Dewasa', 'MTB', '', 'Hitam', 'United', 3, 10000000, 1, NULL, 0, 'detroit_10.png', 5000),
(31, 'Detroit 2.0', 'Detroit-20', 'Dewasa', 'MTB', '', 'Hitam', 'United', 3, 13000000, NULL, NULL, 0, 'detroit_20.png', 5000),
(32, 'Sepeda Gunung Fastron', 'Sepeda-Gunung-Fastron', 'Dewasa', 'MTB', '', 'Hitam Biru', 'Fastron', 2, 15000000, NULL, NULL, 0, 'fastron.png', 5000),
(33, 'Exotik 2689', 'Exotik-2689', 'Dewasa', 'MTB', '', 'Hitam Orange', 'Exotik', 3, 18000000, 1, NULL, 0, 'exotic2689.png', 5000),
(34, 'Sepeda Listrik Selis Murai', 'Sepeda-Listrik-Selis-Murai', 'Listrik', '', '', 'Merah', 'Selis Murai', 1, 15000000, NULL, NULL, 0, 'selismurai.png', 5000),
(35, 'Sepeda Listrik Hornet', 'Sepeda-Listrik-Hornet', 'Listrik', '', '', 'Hitam', 'Hornet', 1, 15000000, NULL, NULL, 0, 'hornet.png', 5000),
(38, 'test', 'test', 'Balita', 'City Bike', '<p>a</p>', 'test', 'test', 5, 50000, NULL, NULL, 0, 'balita1.jpg', 10000);
...
(1, 'test@gmail.com', '$2y$10$SshkzKanORACu73TaenQu.YbHAgXrX.rVFRHPlexUzpr8euLavWq.', 2),
